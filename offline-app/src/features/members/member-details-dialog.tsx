          ...
          {!member ? (
            ...
            <div className="space-y-4">
              ...
              <div className="grid gap-3 sm:grid-cols-3">
                <div className="rounded-xl border border-border bg-background/80 p-4">
                  <p className="text-xs uppercase tracking-widest text-muted-foreground">Marital Status</p>
                  <p className="mt-2 text-foreground capitalize">{member.maritalStatus ? member.maritalStatus.toLowerCase() : "-"}</p>
                </div>
                <div className="rounded-xl border border-border bg-background/80 p-4">
                  <p className="text-xs uppercase tracking-widest text-muted-foreground">YSK ID</p>
                  <p className="mt-2 text-foreground">{member.yskId || "-"}</p>
                </div>
                <div className="rounded-xl border border-border bg-background/80 p-4">
                  <p className="text-xs uppercase tracking-widest text-muted-foreground">Yuva Sangh Family ID</p>
                  <p className="mt-2 text-foreground">{member.yuvaSanghFamilyId || "-"}</p>
                </div>
              </div>
